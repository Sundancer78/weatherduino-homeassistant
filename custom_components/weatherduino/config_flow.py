...
class WeatherDuinoConfigFlow(config_entries.ConfigFlow, domain=DOMAIN):
    ...
    async def async_step_user(self, user_input=None):
        ...
        if user_input is not None:
            ...
            path: str = user_input.get(CONF_PATH, DEFAULT_PATH).strip() or DEFAULT_PATH
...
class WeatherDuinoOptionsFlow(config_entries.OptionsFlow):
    ...
    async def async_step_init(self, user_input=None):
        ...
        current_path = self.config_entry.options.get(CONF_PATH, self.config_entry.data.get(CONF_PATH, DEFAULT_PATH))
